...
namespace InventoryManagement.Sql.Migrations
{
    ...
    [Migration("20230606060159_InitialDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagement.Sql.Entities.Enrols.Purchase", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("InventoryManagement.Sql.Entities.Enrols.PurchaseItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<double>("PurchasesPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("InventoryManagement.Sql.Entities.Enrols.PurchaseItem", b =>
                {
                    ...
                    b.HasOne("InventoryManagement.Sql.Entities.Enrols.Purchase", "Purchase")
                        .WithMany("PurchaseItems")
            ...
            modelBuilder.Entity("InventoryManagement.Sql.Entities.Identities.IdentityModel+UserLogin", b =>
                {
                    ...
                    b.HasOne("InventoryManagement.Sql.Entities.Identities.IdentityModel+User", "Users")
                        .WithMany()
